    ...
    <>
      ...
      <section className="text-center my-16" id="about">
        ...
        <div className="text-gray-500 max-w-md mx-auto mt-4 flex flex-col gap-4">
          ...
          <p>Our commitment to quality means every bite is crafted with the freshest ingredients, ensuring an unforgettable taste experience. Whether youre in the mood for a classic pepperoni pizza, a juicy burger, or a creamy shake, BiteBliss has you covered.</p>
